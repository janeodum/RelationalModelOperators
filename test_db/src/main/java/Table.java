...
public class Table
     ...
     */
    Table project(String attributes) {
     ...
     */
    Table select(Predicate<Comparable[]> predicate) {
     ...
     */
    Comparable[] join (String attributes1, String attributes2, Table table2)
    {
     ...
     * @return  a table with tuples satisfying the equality predicate
     */
    Table i_join (String attributes1, String attributes2, Table table2)
    {
...
ArrayUtil.concat (domain, table2.domain), this.key, r);
     ...
     * @return a table with tuples satisfying the equality predicate
     */
    Table h_join(String attributes1, String attributes2, Table table2) {
     ...
     */
    boolean compatible(Table table2) {
     ...
     */
    Comparable[] extract(Comparable[] t, String[] column) {
     ...
     */
    boolean typeCheck(Comparable[] t) {
        // T O B E I M P L E M E N T E D
     ...
     */
    Class [] extractDom(int [] colPos, Class [] group)
    {
